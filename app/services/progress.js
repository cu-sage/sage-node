...
let prepareSearchQueryForSearchingStudentsProgresses = function (studentID, assignmentIDs = []) {
  let searchObject = {};
  (assignmentIDs.length) ? searchObject.assignmentID = { $in: assignmentIDs } : searchObject.assignmentID = null;
  (studentID) ? searchObject.studentID = studentID : searchObject.studentID = null;
  return searchObject;
};
...
let prepareQueryForFetchProgressesObjectsAccordingToAssignment = function (assignmentID, studentIDs = []) {
  ...
  (studentIDs.length) ? searchObject.studentID = { $in: studentIDs } : searchObject.studentID = undefined;
  return searchObject;
};
