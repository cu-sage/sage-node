...
class ZipReader(object):
    def __init__(self, fp):
        ...
        print("print(self.zip_file)", self.zip_file.namelist())
        #self.json = json.load(self.zip_file.open("project.json"))
        #self.json = json.load(self.zip_file.open("tryitagain.sb2/project.json"))
        self.json = json.load(self.zip_file.open("sageGame.sb2/project.json"))
        # __MACOSX/sageGame/._project.json
        ...
        for filename in self.zip_file.namelist():
            #continue
            if filename == 'project.json' or 'sageGame.sb2/' in filename:
                continue
